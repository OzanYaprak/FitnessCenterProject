...
namespace Antreman.Controllers
{
    public class IlceController : Controller
    {
        ...
        public IlceController(antremanDBContext context)
        {
            _context = context;
        }
        ...
        {
            var antremanDBContext = _context.Districts.Include(d => d.City);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'antremanDBContext.Districts'  is null.");
            }
            var district = await _context.Districts.FindAsync(id);
            if (district != null)
            {
