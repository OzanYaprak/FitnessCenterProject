...
namespace Antreman.Controllers
{
    public class AltKategoriController : Controller
    {
        ...
        public AltKategoriController(antremanDBContext context)
        {
            _context = context;
        }
        ...
        {
            var antremanDBContext = _context.SubCategories.Include(s => s.Category);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'antremanDBContext.SubCategories'  is null.");
            }
            var subCategory = await _context.SubCategories.FindAsync(id);
            if (subCategory != null)
            {
